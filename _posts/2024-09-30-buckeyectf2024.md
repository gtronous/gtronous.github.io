...
This was a begginer challenge. We are provided with a zip file.
```
└─$ file unknown.zip               
...
We are provided with a password protected pdf file. This is a straight forward challenge because it also uses a weak encryption scheme.
```
...
```
We got b895821f14 as cracked password. We now open the pdf using qpdf. It is also possible to use 10420 mode of hashcat to crack this hash plain's password, but this is more direct.
```
