...
This was a bit of a confusing question, fortunatelly the organizers cleared it up by specifying it should be open fullscreen, so 
...
This macthes the traffic of a [Trevor C2](https://github.com/trustedsec/trevorc2). The commands will be sent encrypted via HTTP/S protocol. TrevorC2 is using AES encryption with a cipher. Encrypted commands will be inserted into the Google website inside the oldcss parameter.
